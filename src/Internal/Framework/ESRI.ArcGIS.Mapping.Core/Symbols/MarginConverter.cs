...
{
	/// <summary>
	///Creates a margin from an offset point.  X becomes left and Y becomes top.
	/// </summary>
	...
	public sealed class MarginConverter : IValueConverter
	{
        ...
        {
            if (!(value is Point))
                throw new NotSupportedException(Resources.Strings.ExceptionRequiresPointValue);
    ...
    /// </summary>
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    public sealed class RenderTransformOriginConverter : IValueConverter
    {
        /// <summary>
        /// Modifies the source data before passing it to the target for display in the UI.
        /// </summary>
