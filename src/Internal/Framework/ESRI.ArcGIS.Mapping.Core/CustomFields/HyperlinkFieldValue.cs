...
{
    public class HyperlinkFieldValue : IComparable, IConvertible
    {
        public int CompareTo(object obj)
        {
            if (obj == null)
                return 1;
            if (obj is HyperlinkFieldValue)
                return ToString().CompareTo((obj as HyperlinkFieldValue).ToString());
            else
        ...
        {
            HyperlinkFieldValue other = obj as HyperlinkFieldValue;
            if (other != null)
