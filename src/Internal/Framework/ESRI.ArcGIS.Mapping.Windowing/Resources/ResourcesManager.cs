...
{
    public abstract class ResourcesManagerBase : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            if (string.IsNullOrEmpty((string)parameter))
                return null;
            ResourcesManagerBase reader = value as ResourcesManagerBase;
            if (reader == null)
                return null;
    ...
    public class ResourcesManager : ResourcesManagerBase
    {
        ...
        {
            get { return typeof(ResourcesManager).Assembly; }
        }

        public override string ResourceFileName
        {
			get { return "ESRI.ArcGIS.Mapping.Windowing.Resources.Strings"; }
        }
    }
}
